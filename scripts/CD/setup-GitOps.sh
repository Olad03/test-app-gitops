...
argocd login $ARGOSERVER --insecure --username admin  --password $ARGOPASSWORD  --skip-test-tls --grpc-web
#argocd login $ARGOSERVER --insecure --username clusteradmin2 --password $ARGOPASSWORD
